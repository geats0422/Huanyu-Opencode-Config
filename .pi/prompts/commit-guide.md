---
description: "Analyze staged or unstaged diff and suggest a Conventional Commit message"
subagent: reviewer
---

<!-- Converted from opencode command `commit-guide` (delegates to subagent: git-governance-reviewer). -->
# /commit-guide
