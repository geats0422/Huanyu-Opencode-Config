---
description: "Check release branch readiness and merge-back path"
subagent: reviewer
---

<!-- Converted from opencode command `release-check` (delegates to subagent: git-governance-reviewer). -->
# /release-check
