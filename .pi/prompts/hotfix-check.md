---
description: "Check hotfix branch source, scope, and merge-back path"
subagent: reviewer
---

<!-- Converted from opencode command `hotfix-check` (delegates to subagent: git-governance-reviewer). -->
# /hotfix-check
