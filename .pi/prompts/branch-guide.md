---
description: "Suggest a governance-compliant branch for the current task"
subagent: reviewer
---

<!-- Converted from opencode command `branch-guide` (delegates to subagent: git-governance-reviewer). -->
# /branch-guide
